...
-- Tiempo de generación: 19-11-2017 a las 23:12:20
...
INSERT INTO `actividades` (`id`, `nombre`, `descripcion`, `frecuencia`, `horaInicio`, `horaFin`, `tipo`, `numMaxParticipantes`, `borrado`) VALUES
...
INSERT INTO `entrenamientos` (`id`, `nombre`, `borrado`, `sesiones`) VALUES
(1, 'Principiante', 0, 1),
(2, 'Medio', 0, 2),
(3, 'Avanzado', 0, 3);
...
INSERT INTO `reservas` (`id`, `fechaInicio`, `fechaFin`, `frecuencia`, `borrado`, `usuario_id`, `actividades_id`) VALUES
...
DROP TABLE IF EXISTS `reservas_has_recursos`;
...
INSERT INTO `reservas_has_recursos` (`reservas_id`, `recursos_id`) VALUES
(1, 1),
(2, 2);
...
INSERT INTO `sesiondelineadetabla` (`id`, `completado`, `comentario`, `sesiones_id`, `lineasDeTabla_id`) VALUES
(589, 0, NULL, 172, 1),
(590, 0, NULL, 172, 2),
(591, 0, NULL, 172, 3),
(592, 0, NULL, 172, 4),
...
INSERT INTO `sesiones` (`id`, `completado`, `fecha`, `tablas_id`, `orden_sesion`, `orden_sesion_max`, `usuarios_id`, `entrenamientos_id`, `anterior_id`) VALUES
(172, 0, NULL, 1, 1, 3, 4, 3, NULL),
(173, 0, NULL, 2, 2, 3, 4, 3, 172),
(174, 0, NULL, 3, 3, 3, 4, 3, 173);
...
INSERT INTO `tablas` (`id`, `nombre`, `borrado`) VALUES
(1, 'Tabla 1', 0),
(2, 'Tabla 2', 0),
(3, 'Tabla 3', 0);
...
INSERT INTO `usuarios` (`id`, `login`, `contrasenha`, `nombre`, `apellidos`, `dni`, `email`, `borrado`, `tipo`, `imagen`) VALUES
