...
?>
    <html lang="es">
        ...
        ?>
        <title> <?php echo $strings['Resource']; ?> </title>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row" id="order_search">
                            <?php
                                ...
                                generateOrderAndSearch($listOrder, 'resource');
                            ?>
                        </div>
                        <!-- End of the squares -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12" id="new">
                                <a href='resource_controller.php?action=<?php echo $strings['Insert']; ?>' class="btn btn-md btn-warning" id="newButton">  <?php echo $strings['New']; ?> <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> </a>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <?php
                                    $titles = array('nombre');
                                    generateList ($this->data, 'resource', $titles);
                                ?>
                                <!-- End of the list -->
                            </div>
                        </div>
