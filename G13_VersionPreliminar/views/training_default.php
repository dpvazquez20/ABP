                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row" id="order_search">
                            <?php
                                ...
                                generateOrderAndSearch($listOrder, 'training');
                            ?>
                        </div>
                        <!-- End of the squares -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12" id="new">
                                <a href='training_controller.php?action=<?php echo $strings['Insert']; ?>' class="btn btn-md btn-warning" id="newButton">  <?php echo $strings['New']; ?> <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> </a>
                            </div>
