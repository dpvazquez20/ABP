...
?>
    <html lang="es">
        ...
        ?>
        <title> <?php echo $strings['Modify user']; ?> </title>
            ...
            <div id="body-container" class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <!-- User form -->
                        <div class="col-md-12">
                            <h1 id="headname"> <?php echo $strings['Modify user']; ?> </h1>
                        </div>

                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                <form enctype="multipart/form-data" class="form-horizontal" action='../controllers/user_controller.php?id=<?php echo $this->data[0]['id']; ?>' method='post'>
