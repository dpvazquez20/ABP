<!-- Training modify view -->

<?php
class TrainingModify
{
    private $data;
...
?>
    <html lang="es">
        ...
        ?>
        <title> <?php echo $strings['Modify training']; ?> </title>
            ...
            <div id="body-container" class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <!-- Training form -->
                        <div class="col-md-12">
                            <h1 id="headname"> <?php echo $strings['Modify training']; ?> </h1>
                        </div>

                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                <form class="form-horizontal" action='../controllers/training_controller.php?id=<?php echo $this->data[0]['id']; ?>' method='post'>
                        ...
                        <!--<div class="col-md-12 col-md-offset-5" id="new">
                            <a href='training_line_controller.php?action=<?php echo $strings['Insert']; ?>&idTabla=<?php echo $_REQUEST['id']; ?>' class="btn btn-md btn-warning" id="newButton"> <?php echo $strings['Add exercise']; ?> <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> </a>
                        </div> -->
